        ...
        <section id="features" class="features" style="margin-top: 100px">
            <div class="container">
                <div class="section-title" data-aos="fade-up">
                    ...
                    <p>Ingresa los datos de tu Negocio en nuestra Bolsa Juvenil de Empleos en el formulario e ingresa el perfil del personal que requieres.</p>
                </div>
                        ...
                        <ul class="nav nav-tabs flex-column">
                            <li class="nav-item" data-aos="fade-up" data-aos-delay="100">
                                <a class="nav-link @if($tab == 1) active show @endif" data-bs-toggle="tab" href="#tab-1">
                                    <h3>Registra datos de tu Negocio</h3>
                            ...
                            <li class="nav-item mt-2" data-aos="fade-up">
                                <a class="nav-link @if($tab == 2) active show @endif" data-bs-toggle="tab" href="#tab-2">
                                    <h3>Registra una nueva solicitud de requerimiento de personal</h3>
                                    <p class="text-muted">Si ya registraste previamente tu Negocio y requieres nuevo personal, ingresa el perfil el profesional que requieres.</p>
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane @if($tab == 1) active show @endif" id="tab-1">
                                <div style="padding: 20px 10px">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form class="form-submit" action="{{ route('business.store') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="type" value="2">
                                                <div class="row">
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label for="city_id" class="text-muted mb-2">Ciudad del negocio</label>
                                                    ...
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label for="job_type_id" class="text-muted mb-2">Rubro del Negocio</label>
                                                    ...
                                                    <div class="form-group col-md-12 mb-3">
                                                        <label for="name" class="text-muted mb-2">Nombre de su empresa <i class="fa fa-question-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Nombre de tu empresa"></i></label>
                                                        <input type="text" name="name" class="form-control" placeholder="Empresa constructora Los Hermanos s.r.l." required>
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label for="first_name_person" class="text-muted mb-2">Nombre del Propietario</label>
                                                        <input type="text" name="first_name_person" class="form-control" placeholder="Luis" required>
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label for="last_name_person" class="text-muted mb-2">Apellido el Propietario</label>
                                                        <input type="text" name="last_name_person" class="form-control" placeholder="Flores" required>
                                                    </div>
                                                    <div class="form-group col-md-6 mb-3">
                                                    ...
                                                    <div class="form-group col-md-12 mb-3">
                                                        <label for="description" class="text-muted mb-2">Descripión de su Negocio</label>
                            ...
                            <div class="tab-pane @if($tab == 2) active show @endif" id="tab-2">
                                <div style="padding: 20px 10px">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form class="form-submit" action="{{ route('joboffer.store') }}" method="post">
                                                @csrf
                                                <input type="hidden" name="type" value="2">
                                                <div class="row">
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label for="business_id" class="text-muted mb-2">Negocio</label>
                                                        <select name="business_id" id="select-business_id-2" class="form-control select-business_id" data-id="2" required>
                                                            <option value="">--Seleccione su Negocio--</option>
                                                            @foreach (App\Models\Business::where('deleted_at', NULL)->get() as $item)
                                                            <option value="{{ $item->id }}" data-item='@json($item)'>{{ $item->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="form-group col-md-12 mb-3">
                                                        <label for="details" class="text-muted mb-2">Breve descripción de su solicitud de personal</label>
                                                        <textarea name="details" class="form-control" rows="3" placeholder=""></textarea>
                                                    </div>
