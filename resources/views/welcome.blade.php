            ...
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
                    <div>
                        ...
                        <div class="col-lg-6">
                            <a href="{{ url('job_offer')}}" class="btn-get-started scrollto"><i class="fa fa-shopping-cart"></i> Ver Ofertas Laborales</a>
                        </div><p></p>
                        
                        <div class="col-lg-6">
                            <a href="{{ url('register-person')}}" class="btn-get-started scrollto"><i class="fa fa-user"></i> Soy Persona</a><p></p>
                            <a href="{{ url('register-business')}}" class="btn-get-started scrollto"><i class="fa fa-university"></i> Soy Negocio</a>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="count-box">
                            ...
                            <span data-purecounter-start="0" data-purecounter-end="{{ App\Models\Person::where('type', 1)->count() }}" data-purecounter-duration="1" class="purecounter"></span>
